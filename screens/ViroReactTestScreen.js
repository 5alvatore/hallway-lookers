...
export default class ViroReactTestScreen extends React.Component {
    ...
    return (
      <ViroARScene>
        ...
        >
          ...
          >
            <ViroImage
              // source={require("../assets/BannerImages/Erie_banner.jpg")}
              source={
                hotspotData.title == "Erie Hall"
                  ? require("../assets/BannerImages/Erie_banner.jpg")
                  : hotspotData.title == "Lambton Tower"
                  ? require("../assets/BannerImages/Lambton_banner.jpg")
                  : hotspotData.title == "Essex Hall"
                  ? require("../assets/BannerImages/Essex_banner.jpg")
                  : ""
              }
              style={{ flex: 0.5 }}
            />
  ...
  gotToMiniGame = (hotspotData) => {
    ...
    if (hotspotData.imageUrl == "erie" || hotspotData.imageUrl == "essex") {
      this.props.navigation.navigate("MiniGameOne", {
        dataFromAR: hotspotData,
      });
    }
    // play wordle if hotspot 1
    else if (hotspotData.imageUrl == "lambton") {
      this.props.navigation.navigate("MiniGameTwo", {
        dataFromAR: hotspotData,
      });
    }
  };
